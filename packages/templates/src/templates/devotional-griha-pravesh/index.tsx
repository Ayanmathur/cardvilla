...
import { devotionalGrihaPraveshSchema } from './schema';
  ...
  return (
    <InvitationLayout data={data} className={styles.container}>
      <div className={styles.content}>
        ...
        <h1 className={styles.headline}>{data.ceremony_title || "Griha Pravesh & Vastu Shanti Puja"}</h1>
        <p className={styles.subline}>Seeking Divine Blessings for Our Home</p>
