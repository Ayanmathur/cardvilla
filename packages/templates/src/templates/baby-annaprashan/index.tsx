...
import { babyAnnaprashanSchema } from './schema';
  ...
  return (
    <InvitationLayout data={data} className={styles.container}>
      <div className={styles.content}>
        ...
        <h1 className={styles.headline}>{data.child_name || "Annaprashan Ceremony"}</h1>
        <p className={styles.subline}>First Solid Food & Blessing Ceremony</p>
