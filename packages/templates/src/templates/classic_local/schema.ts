...
export const classicLocalSchema: ConfigSchema = [
  // Content fields (per-instance, client-editable)
  { key: 'full_name', label: 'Full Name', type: 'text', editableBy: 'client', required: true, fieldScope: 'instance', placeholder: 'Rajesh Sharma' },
  { key: 'company_name', label: 'Business Name', type: 'text', editableBy: 'client', required: false, fieldScope: 'instance', placeholder: 'Sharma Heritage Traders' },
  { key: 'title', label: 'Title / Role', type: 'text', editableBy: 'client', required: false, fieldScope: 'instance', defaultValue: 'Proprietor' },
  ...
  { key: 'logo', label: 'Logo / Emblem', type: 'image', editableBy: 'client', required: false, fieldScope: 'instance' },
  ...
  { key: 'cta_call', label: 'Call Button Text', type: 'text', editableBy: 'admin_only', required: false, fieldScope: 'template', defaultValue: 'Call Us' },
  { key: 'cta_directions', label: 'Directions Button Text', type: 'text', editableBy: 'admin_only', required: false, fieldScope: 'template', defaultValue: 'Get Location' },
