...
import { devotionalGaneshChaturthiSchema } from './schema';
  ...
  return (
    <InvitationLayout data={data} className={styles.container}>
      <div className={styles.content}>
        ...
        <h1 className={styles.headline}>{data.ceremony_title || "Ganesh Sthapana & Puja"}</h1>
        <p className={styles.subline}>Ganpati Bappa Morya</p>
