...
export const shutterMomentSchema: ConfigSchema = [
  ...
  { key: 'company_name', label: 'Studio / Business Name', type: 'text', editableBy: 'client', required: false, fieldScope: 'instance', placeholder: 'Studio Name' },
  { key: 'title', label: 'Title / Role', type: 'text', editableBy: 'client', required: false, fieldScope: 'instance', defaultValue: 'Photographer' },
  { key: 'specialty', label: 'Specialty', type: 'text', editableBy: 'client', required: false, fieldScope: 'instance', placeholder: 'Wedding Photography | Portraits & Events' },
  ...
  { key: 'address', label: 'Studio Address', type: 'address', editableBy: 'client', required: false, fieldScope: 'instance' },
