...
import { kidsBirthdayPrincessSchema } from './schema';
  ...
  return (
    <InvitationLayout data={data} className={styles.container}>
      <div className={styles.content}>
        ...
        <h1 className={styles.headline}>{data.child_name || "Royal Princess Party"}</h1>
        <p className={styles.subline}>A Magical Birthday Kingdom</p>
